...
export default class Map extends Component {
      ...
      .then(({ data }) => {
        ...
        if (this.hoverGenre.length < 1) {
          ...
          let values = [
            ...
            [
              this.hoverGenre[0].electronic,
              genderColors.electronic,
              "electronic",
            ],
  ...
  componentDidMount() {
    ...
    polygonTemplate.events.on(
      ...
      function (event) {
        this.getBestGenre(
          countryTag[event.target.dataItem.dataContext.id],
          event.target
        )
      },
      this
        ...
        .then(({ data }) => {
          ...
          if (this.hoverGenre.length < 1) {
            ...
            let values = [
              [this.hoverGenre[0].blues, genderColors.blues, "blues"],
              [
                this.hoverGenre[0].classical,
                genderColors.classical,
                "classical",
              ],
              [
                this.hoverGenre[0].electronic,
    ...
    return (
      <div className="App">
        <div className="map-breadcrumb">
          <h1 style={{ color: "white" }}>MUSIC GENRES ACROSS THE WORLD</h1>
        </div>
        <DecadeInput
        ...
        <CountryDetails
          curDecade={this.curDecade}
          isactive={this.countryclicked}
          data={this.albumData}
          genre={this.genres}
